...
One of the other users looked farthet to the future and noticed that when the number of areas grow, it might be very useful to group them by continent, country or region.
...
In this, all the participants agreed that remembering this area was not hard at all.
\subsubsection{How satisfied you were with this part of the application}
All the participants were satisfied, the suggestions which they made were only suggestions and did not change the user experience.
...
\subsubsection{Do you want to add anything}
\chapter{Conclusion}
\section{In summary}
\section{Future work}
\end{document}